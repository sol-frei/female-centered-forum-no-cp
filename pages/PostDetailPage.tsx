                ...
                <div className="mt-6 bg-zinc-50 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-3xl font-bold text-zinc-800">{bookRating.post_final_score.toFixed(1)}</div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="bg-white rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-zinc-700">{bookRating.post_impressed_score}</div>
